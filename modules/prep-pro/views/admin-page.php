    ...
    <div style="background: #fff; padding: 20px; margin: 20px 0; border: 1px solid #ccd0d4; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
        ...
        <form method="get" action="<?php echo esc_url(admin_url('admin.php')); ?>">
            ...
            <div style="display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
                ...
                <span><strong><?php esc_html_e('City Status:', 'directory-helpers'); ?></strong>
                    <label style="margin-left: 8px;">
                        <input type="radio" name="city_status" value="all" <?php checked($city_status, 'all'); ?> />
                        <?php esc_html_e('All', 'directory-helpers'); ?>
                    </label>
                    <label style="margin-left: 8px;">
                        <input type="radio" name="city_status" value="new" <?php checked($city_status, 'new'); ?> />
                        <?php esc_html_e('New', 'directory-helpers'); ?>
                    </label>
                    <label style="margin-left: 8px;">
                        <input type="radio" name="city_status" value="existing" <?php checked($city_status, 'existing'); ?> />
                        <?php esc_html_e('Existing', 'directory-helpers'); ?>
                    </label>
                </span>
